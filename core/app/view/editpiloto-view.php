...
$libro = LibroData::getById($_GET["id"]);
$autor =  LibroData::getAutor();
...
<div class="row">
   ...
   <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="name"  required value="<?php echo $libro->nombre;?>" class="form-control" id="name" placeholder="Nombre">
    </div>
  </div>
