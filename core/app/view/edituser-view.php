...
<div class="row">
	...
	<br>
		<form class="form-horizontal" method="post" id="addproducto" action="index.php?view=updateuser" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="email" required value="<?php echo $user->email;?>" class="form-control" id="email" placeholder="Email">
    </div>
  </div>
